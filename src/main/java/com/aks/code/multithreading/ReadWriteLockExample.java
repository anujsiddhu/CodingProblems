        ...
        for (int readerIndex = 0; readerIndex < numberOfReaderThreads; readerIndex++) {
            Thread reader = new Thread(() -> {
                for (int i = 0; i < 100000; i++) {
                    ...
                    int sum = inventoryDatabase.getNumberOfItemsInPriceRange(lowerBoundPrice, upperBoundPrice);
                    System.out.println("NumberOfItemsInPriceRange lowerBoundPrice " + lowerBoundPrice + " upperBoundPrice " + upperBoundPrice
                            + " are " + sum);
                }
            });
